...
import 'package:driver_frontend_we_app/pages/auth/login/register/register_page.dart';
import 'login_help_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: Column(
          children: [
            // Top section with logo, back button, and help icon
            Container(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const LoginHelpPage()),
                          );
                        },
                      ),
                    ],
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Container(
                  color: const Color.fromARGB(255, 244, 243, 242), // Light beige background
                  padding: const EdgeInsets.all(16.0),
                  child: Column(
