...
class DocumentUploadHelpPage extends StatefulWidget {
  const DocumentUploadHelpPage({super.key});

  @override
  State<DocumentUploadHelpPage> createState() => _DocumentUploadHelpPageState();
}

class _DocumentUploadHelpPageState extends State<DocumentUploadHelpPage> {
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    Text(
                      'Hi, Janu. Are you having trouble completing the document upload process?',
                      style: TextStyle(
                    ...
                    Text(
                      'Fields in red colour are mandatory. Below is an example of each step.',
                      style: TextStyle(
                        fontSize: bodyFontSize,
                        color: Colors.black,
                      ),
                    ),
                    SizedBox(height: padding), // Space before the image
                    // Placeholder image or example image
                    Center(
                      child: Image.asset(
                        'assets/Screenshot1.png', // Replace with your image asset
                    ...
                    SizedBox(height: padding), // Space after the image and before the TextField
                    Container(
                      padding: EdgeInsets.all(padding),
